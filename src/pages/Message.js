...
const Message = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
          const q = query(collection(db, "products"), where("product_id", "==", productId.productId))
            ...
            {/* <MessageContainer> */}
                ...
                <MessageContainer>
                    <form onSubmit={formik.handleSubmit}>
                        <h3>DESCRIPTION</h3>
                        <InputTextArea type="text" name="message" placeholder="Type in your message" onChange={formik.handleChange}/>
